...
Entrás a la app, elegís el cliente, ponés la fecha y la duración (en horas y minutos) y guardás. Podés marcar si fue una hora facturable o de planificación propia. En el dashboard ves el total del mes por cliente automáticamente.
...
**¿Cómo funciona el cotizador para traductoras?**
Pegás el texto a traducir en la app y ella cuenta automáticamente cuántas palabras tiene en total, cuántas son únicas y cuántas son repetidas. Si tenés configurado un descuento por repeticiones (el estándar es 50%), el precio se calcula solo. También podés elegir modo manual y ajustar vos el precio final.
...
**¿Cómo genero el tarifario para enviarle al cliente?**
Elegís el cliente y el período (por ejemplo, mayo 2026), la app muestra el resumen completo con horas trabajadas, tarifa y total, y con un botón descargás un PDF prolijo listo para mandar por WhatsApp o email.

---

**¿Puedo tener clientes que cobro por hora y otros por palabra?**
Sí. Cuando das de alta un cliente elegís si se factura por hora o por palabra. La app adapta todo el flujo según el tipo: registro de tiempo para los de hora, cotizador de palabras para los de traducción.
...
Sí. Está diseñada para que funcione bien tanto en celular como en computadora. Podés cargar horas desde el celular entre clase y clase.

---

**¿Mis datos están seguros?**
Sí. Cada usuaria solo ve sus propios datos. La app usa Supabase, una plataforma de base de datos segura, y cada cuenta está protegida con usuario y contraseña.

---

**¿Puedo probarla antes de pagar?**
Sí. Habrá una versión de prueba gratuita al momento del lanzamiento. Anotate en la lista de espera para ser de las primeras en acceder.

---

**¿Cómo me anoto para el lanzamiento?**
Dejás tu email en el formulario de esta página y te avisamos cuando esté disponible. Las primeras anotadas tienen acceso prioritario y precio especial.
